...
/**
 *	\file       htdocs/core/modules/commande/doc/pdf_MeehaaGSTALL.modules.php
 *	\ingroup    commande
 *	\brief      Fichier de la classe permettant de generer les commandes au modele MeehaaGSTALL
 */
...
/**
 *	Classe to generate PDF orders with template MeehaaGSTALL
 */
class pdf_MeehaaGSTALL extends ModelePDFCommandes
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "MeehaaGSTALL";
		$this->description = $langs->trans('CO from MeeHaa Surgitech TN-GST ALL');

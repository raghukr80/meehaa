...
class pdf_MeehaaGST extends ModelePDFCommandes
{
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "MeehaaGST";
		$this->description = $langs->trans('Proforma Invoice from New K.R.Pharma-CA North East-SGST');
	 ...
	 *  @return	void
	 */
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $titlekey="Proforma Invoice")
	{
		...
		if ($showaddress)
		{
			...
			$pdf->SetXY($posx,$posy+2);
                       		$pdf->SetFont('','B', $default_font_size);
			$pdf->MultiCell(80, 4, 'New K.R. Pharma ', 0, 'L');
                        		$pdf->SetFont('','', $default_font_size - 2);
                        		$pdf->MultiCell(82, 4, '(Consignee Agent of Shalex Overseas Pvt. Ltd.) ', 0, 'L');
			$pdf->SetFont('','', $default_font_size - 1);
                        		$pdf->MultiCell(84, 4, 'H.No.350, M.T.Road ', 0, 'L');
			$pdf->MultiCell(86, 4, 'Near Geeta Nagar P.S. ', 0, 'L');
                        		$pdf->MultiCell(88, 4, 'Guwahati-781024 ', 0, 'L');
                        		$pdf->MultiCell(90, 4, 'Assam ', 0, 'L');
                        		$pdf->MultiCell(92, 4, 'Telephone:+91-98594 59688 ', 0, 'L');
                        		$pdf->SetFont('','B', $default_font_size - 1);
                        		$pdf->MultiCell(94, 4, 'GSTIN: 18AQRPR7486C1Z3 ', 0, 'L');

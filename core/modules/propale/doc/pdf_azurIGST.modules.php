...
/**
 *	\file       htdocs/core/modules/propale/doc/pdf_azurIGST.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele AzurIGST
 */
...
/**
 *	Class to generate PDF proposal AzurIGST
 */
class pdf_azurIGST extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "azurIGST";
		$this->description = $langs->trans('IGST QUOTE fROM MeeHaa');
			...
			else
			{
				...
				foreach($this->tva as $tvakey => $tvaval)
				{
					if ($tvakey != 0)    // On affiche pas taux 0
					{
						...
						$totalvat =$outputlangs->transnoentities("Total IGST").' ';

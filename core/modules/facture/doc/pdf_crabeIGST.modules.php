...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_crabeIGST.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate customers invoices from crabeIGST model
 */
...
/**
 *	Class to manage PDF invoice template CrabeIGST
 */
class pdf_crabeIGST extends ModelePDFFactures
{
	var $db;
	var $name;
	var $description;
